!(function (t, e) {
    ...
    function Ka(e) {
        ...
        return function (t) {
            return (
                ~~(Math.round(parseFloat(t) / e) * e * r) / r +
                (p(t) ? 0 : Da(t))
            );
        };
    }
        ...
        return Ba(G(t) ? !e : !n, function () {
            return G(t)
                ...
                : (r = r || 1e-5) &&
                      ...
                      ~~(
                          Math.round((t + Math.random() * (e - t)) / r) *
                          r *
                          n
                      ) / n;
        });
    ...
    function cb(t, e) {
        ...
        if (!c) {
            if (
                ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Tt[t])
            )
                c = Tt[t];
            else if ("#" === t.charAt(0))
                (4 === t.length &&
        ...
        Rt =
                ...
                if (n && n.smoothChildTiming && this._ts) {
                    for (
                        ...
                        (n.parent._time !==
                            ...
                            (n = n.parent));
                    this.parent ||
                        ua(this._dp, this, this._start - this._delay);
                }
                return (
                    (this._tTime === t && this._dur) || ca(this, t, e),
                    this
                );
            }),
            (Bt.time = function time(t, e) {
                return arguments.length
                    ? this.totalTime(t + sa(this), e)
                    : this._time;
            }),
            ...
            (Bt.timeScale = function timeScale(t) {
                ...
                return arguments.length
                    ? e
                        ? ((this._end =
                              this._start + this._tDur / (this._ts = t || B)),
            ...
            (Bt.repeat = function repeat(t) {
                return arguments.length
                    ? ((this._repeat = t), ya(this))
                    : this._repeat;
            }),
            (Bt.repeatDelay = function repeatDelay(t) {
                return arguments.length
                    ? ((this._rDelay = t), ya(this))
                    : this._rDelay;
            }),
    ...
    var Et = (function (i) {
        ...
        return (
            (t.to = function to(t, e, r, n) {
                return (
                    new Xt(t, aa(arguments, 0, this), Aa(this, p(e) ? n : r)),
                    this
                );
            }),
            (t.from = function from(t, e, r, n) {
                return (
                    new Xt(t, aa(arguments, 1, this), Aa(this, p(e) ? n : r)),
                    this
                );
            }),
            (t.fromTo = function fromTo(t, e, r, n, i) {
                return (
                    new Xt(t, aa(arguments, 2, this), Aa(this, p(e) ? i : n)),
                    this
                );
            }),
                    ...
                    for (; a; )
                        ((e = a._prev),
                            ...
                            n <
                                (r = a._end =
                                    a._start +
                                    a._tDur / Math.abs(a._ts || a._pauseTS)) &&
                                a._ts &&
                                (n = $(r)),
                            (a = e));
                    ((i._dur =
                        i === R && i._time > n ? i._time : Math.min(D, n)),
                        (i._tDur =
                            h && (i._dur || u)
                                ? 1e20
                                : Math.min(D, n * (o + 1) + u)),
                        (i._end =
                            i._start +
                            (i._tDur / Math.abs(i._ts || i._pauseTS) || 0)),
                        (i._dirty = 0));
                }
                return i._tDur;
            }),
    ...
    function Bb(t, e, i, a, s, u) {
        ...
        if (
            ...
            ((i._pt = l =
                new te(i._pt, s, t, 0, 1, h.render, h, 0, h.priority)),
            i !== d)
        )
            for (
                f = i._ptLookup[i._targets.indexOf(s)], c = h._props.length;
                c--;
            )
                f[h._props[c]] = l;
        return h;
                ...
                return isNaN(p + i)
                    ? (c || e in t || K(e, i),
                      function _addComplexStringPropTween(t, e, r, n, i, a, s) {
                          ...
                          return (
                              (_.c =
                                  m < n.length ? n.substring(m, n.length) : ""),
                              (_.fp = s),
                              (nt.test(n) || p) && (_.e = 0),
                              (this._pt = _)
                          );
        ...
        Xt = (function (k) {
            ...
            return (
                        ...
                        if (
                            ...
                            if (((n = _), (l = this.timeline), this._repeat)) {
                                ...
                                a !== o &&
                                    ...
                                    !this._lock &&
                                    ((this._lock = 1),
                                    (this.render(s * a, !0).invalidate()._lock =
                                        0));
                            }
                ...
                (t.kill = function kill(t, e) {
                    ...
                    if (this.timeline)
                        return (this.timeline.killTweensOf(t, e), this);
                    var r,
                        i,
                        a,
                        s,
    ...
    var ee = {
        ...
        defaults: function defaults(t) {
            return (
                t && t.ease && (t.ease = Dt(t.ease, E.ease)),
                ia(E, t || {})
            );
        },
            ...
            De[e]
                ? ((i = Ve(t, n)),
                  (i =
                      "transformOrigin" !== e
                          ? i[e]
                          : Qe(Yc(t, $e)) + i.zOrigin + "px"))
                : ((i = t.style[e]) && "auto" !== i && !n) ||
                  (i = Yc(t, e) || Y(t, e)),
            r ? gd(t, e, i, r) + r : i
        );
    }
        ...
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if ("all" === o || !0 === o) ((s.cssText = ""), (n = 1));
                ...
                for (i = (o = o.split(",")).length; -1 < --i; )
                    ((r = o[i]),
                        De[r] &&
                            ((n = 1), (r = "transformOrigin" === r ? $e : Ne)),
                        dd(a, r));
            n &&
                (dd(a, Ne),
                (n = a._gsap) &&
                    (n.svg && a.removeAttribute("transform"), delete n.x));
        }
    }
            ...
            return (
                ...
                d !== qe &&
                    ...
                    r.svg &&
                        ...
                        (r.forceCSS =
                            t.setAttribute("transform", "") || !pd(Yc(t, Ne))),
                ...
                (r.zOrigin = parseFloat(I.split(" ")[2]) || 0) &&
                    (F[$e] = Qe(I)),
                            ...
                            if (
                                ...
                                ((c = (a + "").substr((u + "").length)) !==
                                    ...
                                    (this._pt = new te(
                                        ...
                                        u,
                                        d ? d * o : o - u,
                                        "px" !== p || !1 === e.autoRound || _
                                            ? Ic
                                            : Lc,
                                    )),
                                    (this._pt.u = p || 0),
                                    c !== p &&
                                        ((this._pt.b = a), (this._pt.r = Kc)));
